            ...
            <div className="flex items-center">
              {!showPromoInput && !promoApplied ? (
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-semibold text-[#429874] hover:text-[#357a5d] rounded-lg hover:bg-green-50 transition-colors border border-transparent hover:border-green-200"
                >
                ...
                <div className="inline-flex items-center gap-2 bg-green-50 px-3 py-2 rounded-lg border border-green-200">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="w-28 px-3 py-2 text-xs font-medium border border-slate-200 rounded-lg focus:ring-2 focus:ring-[#429874] focus:border-[#429874] transition-all"
                    onKeyDown={(e) => e.key === "Enter" && handleApplyPromo()}
                  />
                  <button
                    onClick={handleApplyPromo}
                    className="px-3 py-2 bg-[#429874] text-white rounded-lg text-xs font-semibold hover:bg-[#357a5d] transition-colors shadow-sm"
                  >
                    {t.apply}
                  </button>
                  <button
