      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 text-center">
          <div className="flex flex-wrap items-center justify-center gap-2">
            <span className="text-slate-700 text-sm font-medium">{t("status.currentlyActive")}</span>
            <span className="px-3 py-1 rounded-full bg-[#d4ede3] text-[#285c46] text-sm font-semibold border border-[#a9dbc7] max-w-[min(100vw-2rem,520px)] truncate">
