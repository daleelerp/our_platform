...
import { dedupeErpSystemsByProviderSlug } from "@/lib/dedupeErpSystems";
...
export default async function HomePage() {
  ...
  try {
    ...
    // Active / coming soon comes only from Admin → ERP Systems (is_active), not from plans
    const systems = dedupeErpSystemsByProviderSlug(erpSystemsData || []);
    erpSystems = systems;
